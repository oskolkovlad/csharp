...
namespace Tuples_and_Struct
{
    struct User
    {
        // В структурах можно использовать конструкторы, но они должны инициализировать все поля

        // В отличии от классов в структуре нельзя инициализировать поля напрямую при их объявлении
        public string name;
        public byte age;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Когда мы создаем объект структуры, то обязательно надо проинициализировать все поля структуры перед получением
            // их значений или перед вызовом методов структуры
            // Поля можно также как и в классах задать с помощью инициализатора, то проинициализовать необходимо все поля!
            User tom;
            tom.name = "Tom";
            tom.age = 45;
            tom.GetInfo();
